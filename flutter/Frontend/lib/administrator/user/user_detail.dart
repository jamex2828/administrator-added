  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body:Container(
          child:Padding(padding: const EdgeInsets.all(19.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Padding(padding: const EdgeInsets.all(19),
              child:Text("Id: "+user.id.toString(),style: const TextStyle(
                fontSize: 20
              ),),),
              Padding(padding: const EdgeInsets.all(19),
              child:Text("Name: "+user.name,style: const TextStyle(
                fontSize: 20
              ),),),
              Padding(padding: const EdgeInsets.all(19),
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  MaterialButton(onPressed: deleteUser,
                    color: Colors.blue,
                    textColor: Colors.white,
